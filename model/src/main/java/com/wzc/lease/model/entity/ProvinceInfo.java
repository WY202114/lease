...
@Schema(description = "省份信息表") // OpenAPI 注解，描述模型或字段含义
@TableName(value = "province_info") // MyBatis-Plus 注解，指定实体对应的数据表
@Data // Lombok 注解，自动生成 getter/setter/toString 等方法
public class ProvinceInfo extends BaseEntity { // 定义实体类

    private static final long serialVersionUID = 1L; // 序列化版本号，用于反序列化兼容性控制

    @Schema(description = "省份名称") // OpenAPI 注解，描述模型或字段含义
