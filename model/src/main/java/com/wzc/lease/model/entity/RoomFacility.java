...
@Schema(description = "房间&配套关联表") // OpenAPI 注解，描述模型或字段含义
@TableName(value = "room_facility") // MyBatis-Plus 注解，指定实体对应的数据表
@Data // Lombok 注解，自动生成 getter/setter/toString 等方法
@Builder // Lombok 注解，支持使用构建者方式创建对象
public class RoomFacility extends BaseEntity { // 定义实体类
    ...
    @Schema(description = "房间设施id") // OpenAPI 注解，描述模型或字段含义
